"""POC-A LGN with learnable TopK interconnect.

Mirrors configs/poc_a_lgn.py, but swaps the fixed pi_a/pi_b random routing
for a learnable Top-K softmax router (K=5 candidates per pair-slot).
"""
